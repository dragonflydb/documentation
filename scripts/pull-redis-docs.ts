...
const DRAGONFLY_SUPPORTED_COMMANDS =
    ...
    "PEXPIREAT,SUBSTR,SADDEX,JSON.RESP,JSON.MGET,RENAME,PING,SETEX,GET,LPOS,ZLEXCOUNT,COMMAND,ZSCAN," +
    ...
    "JSON.MSET,JSON.MERGE,JSON.GET," + 
    "APPEND,XADD,PREPEND,FT.CREATE,FT.DROPINDEX,FT.INFO,FT._LIST,FT.SEARCH,FT.PROFILE,FT.SYNUPDATE,FT.SYNDUMP".split(
    ","
  );
