...
- Create a data store in the **private network**. Read more on [data store security](./datastores#security).
...
A data store in a private network provides better security and performance and reduces data transfer costs.
