...
- Create a data store in the private network with **private connectivity**. Read more on [data store security](./datastores#security).
...
A private connectivity data store in a private network provides better security and performance and reduces data transfer costs.
