...
To connect to a private connectivity datastore from your local machine, you need to create a Client VPN endpoint in your VPC that is peer connected to the Dragonfly Cloud private network where your private connectivity datastore is deployed.
...
Once the profile is connected, you should be able to access the private connectivity datastore from your local machine.
