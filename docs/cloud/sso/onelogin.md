---
description: "Set up SAML-based single sign-on between Dragonfly Cloud and OneLogin."
sidebar_position: 5
---
...
1. **Create SSO Connection with IdP in Dragonfly Cloud**: Set up the connection and obtain SAML configuration details
...
3. Enter the connection details:
   ...
   - **Provider Type**: Select **SAML: Custom** (OneLogin uses standard SAML v2)
