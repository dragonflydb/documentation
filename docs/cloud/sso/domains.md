...
- **SSO Configuration**: You can only create SSO connections with IdP for verified domains.
...
1. Navigate to **Access > Domains** in Dragonfly Cloud.
...
- Or create separate SSO connections with IdP for different domains if they use different identity providers
