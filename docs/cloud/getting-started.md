...
After signing up you will land on the *Data Stores* page, you can create a your first *data store* by clicking the [+Data Store](https://dragonflydb.cloud/datastores/new) button.  
