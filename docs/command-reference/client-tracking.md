---
description: Enable or disable server assisted client side caching support
---
...
for [server assisted client side caching](https://redis.io/topics/client-side-caching).
...
refer to [the main client side caching documentation](https://redis.io/topics/client-side-caching) for the details. This manual page is only a reference for the options of this subcommand.
