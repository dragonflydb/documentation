---
description: Return never seen elements in multiple streams, with IDs greater
  than the ones reported by the caller for each stream. Can block.
---
...
we recommend to read [our introduction to Redis Streams](https://redis.io/topics/streams-intro).
...
Reading the [Redis Streams introduction](https://redis.io/topics/streams-intro) is highly
