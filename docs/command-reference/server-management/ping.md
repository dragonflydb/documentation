...
[Simple string reply](https://valkey.io/topics/protocol/#simple-strings), and specifically `PONG`, when no argument is provided.

[Bulk string reply](https://valkey.io/topics/protocol/#bulk-strings) the argument provided, when applicable.
