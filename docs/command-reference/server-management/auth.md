...
2. If a Redis 6.0 instance, or greater, is using the [Redis ACL system](https://redis.io/topics/acl).
...
defined in the ACL list (see `ACL SETUSER`) and the official [ACL guide](https://redis.io/topics/acl) for more information.
