---
description: Return information and entries from a stream consumer group pending
...
[introduction to Redis Streams](https://redis.io/topics/streams-intro). The `XACK` command
...
explained in the [streams intro](https://redis.io/topics/streams-intro) and in the
