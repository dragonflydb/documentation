...
- [Bulk string reply](https://valkey.io/topics/protocol/#bulk-strings): the element being
  popped from `source` and pushed to `destination`, when successful.
- [Nil reply](https://valkey.io/topics/protocol/#bulk-strings) when the command times out.
