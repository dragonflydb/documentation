...
[Integer reply](https://valkey.io/topics/protocol/#integers): the list length after a successful insert operation, `0` if the `key` doesn't exist, and `-1` when the `pivot` wasn't found.
