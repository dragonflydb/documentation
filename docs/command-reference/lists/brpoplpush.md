...
[Bulk string reply](https://valkey.io/topics/protocol/#bulk-strings): the element being popped from `source` and pushed to `destination`.
If `timeout` is reached, a [Null reply](https://valkey.io/topics/protocol/#bulk-strings) is returned.
