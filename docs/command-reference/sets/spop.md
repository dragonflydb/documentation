...
[Bulk string reply](https://valkey.io/topics/protocol/#bulk-strings): the removed member, or `nil` when `key` does not exist.

When called with the `count` argument:

[Array reply](https://valkey.io/topics/protocol/#arrays): the removed members, or an empty array when `key` does not exist.
