...
[Integer reply](https://valkey.io/topics/protocol/#integers): Number of keys that were made sticky successfully: those that existed and were not already sticky.
