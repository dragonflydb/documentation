---
description: Create a function with the given arguments (name, code, description)
---
...
For the Lua engine, the implementation should declare one or more entry points to the library with the [`redis.register_function()` API](https://redis.io/topics/lua-api#redis.register_function).
